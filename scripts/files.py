...
TABLE_COLS = ('id', 'md5', 'url', 'title', 'archive', 'is_sponsored',
                            'is_partner', 'partner', 'created', 'updated')
COL_LABELS = {'id': 'ID', 'md5': 'md5', 'url': 'URL', 'title': 'Title',
                'archive': 'Archive', 'is_sponsored': 'Sponsored?',
                'is_partner':'Partner?', 'partner': 'Partner Organization',
                'created': 'Date Created', 'updated': 'Last Update'}
METADATA_KEYS = ('url', 'title', 'images', 'created', 'is_partner', 
                    'is_sponsored','archive', 'partner')
...
def add_to_database(files):
    """ Takes metadata from info.json and writes it to database, adding 
        potentially empty keys from METADATA_KEYS """
